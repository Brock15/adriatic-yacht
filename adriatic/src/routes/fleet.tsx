...
import yacht4 from "@/assets/yacht-4.jpg";
import yacht5 from "@/assets/yacht-5.jpg";
import yacht6 from "@/assets/yacht-6.jpg";
import yacht7 from "@/assets/yacht-7.jpg";

export const Route = createFileRoute("/fleet")({
  head: () => ({
    meta: [
      { title: "The Fleet — Adriata" },
      { name: "description", content: "Seven privately-held vessels, from a 1974 classic ketch to contemporary motor yachts, maintained by a single family atelier." },
            ...
            >
              ...
              <div>
                ...
                <dl className="mt-10 grid grid-cols-2 gap-6 border-t border-border pt-8 text-sm">
                  ...
                  <Spec label="Home Port" value={y.homePort} />
                  <Spec label="Cruising Grounds" value={y.cruisingGrounds} />
                </dl>
